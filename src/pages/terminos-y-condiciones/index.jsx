...
const TerminosCondiciones = () => {
    return <Layout>
        <section className={`${styles.TerminosCondicionesPage} Card page`}>
            <p>Términos y Condiciones de Uso para Aliados Comerciales – Pikplay Colombia</p>
            ...
            <p>
                3. Gastos de Aplicativo y Créditos para Usuarios
            ...
            <p>
                4. Calidad y Garantía de los Productos/Servicios
